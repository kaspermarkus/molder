...
define(['backbone', 'globals', 'session', 'jsplumb', 'app/nodeListing/NodeListingView', 'app/menuBar/menuBar', 'jquery', 'jquery-ui', 'jquery-sortable-min', 'bootstrap'],
  function(Backbone, Globals, Session, jsplumb, NodeListingView, MenuBar) {
  'use strict';
